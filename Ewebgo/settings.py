"""
Django settings for Ewebgo project.
...
WSGI_APPLICATION = 'Ewebgo.wsgi.application'
...
STATIC_URL = '/static/'
MEDIA_URL='/media/'
MEDIA_ROOT=os.path.join(BASE_DIR,'generalzone/static/Uploaded')
